...
public class frmCarrito extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Empanadas Ya", "3.75", "4.00"},
                {"Tomates Cherry", "5.25", "5.89"},
                {null, null, null},
                {null, null, null},
                {null, null, null},
                {null, null, null},
            ...
            new String [] {
                "Productos", "Presio Afiliado", "Presio No Af"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 370, 330));

        jLabel3.setText("A pagar:");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 420, 50, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 400, 240, 50));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 510, 80, 80));

        jButton2.setText("Pagar con tarjeta");
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 460, -1, -1));
